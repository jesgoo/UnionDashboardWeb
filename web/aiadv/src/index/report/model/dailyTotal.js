...
(function () {
    ...
    mf.index.report.model.dailyTotal = new er.Model({
        QUERY_MAP: {},
        ...
        modelLoader: new er.Model.Loader(function () {
            ...
            mf.parallelAjax([
                ...
                var reportList = $.map(reportData.reduce(function (memory, dayData) {
                    var dateItem = memory[dayData.date];
                    if (!dateItem) {
                        dateItem = memory[dayData.date] = {
                            impression: 0,
                            cost: 0,
                            click: 0
                        };
                    ...
                    dayData.date = date;
                    dayData.cost = dayData.cost || 0;
                    dayData.click = dayData.click || 0;
                    dayData.impression = dayData.impression || 0;
                    dayData.cost /= 1000;
                    dayData.ctr = (dayData.impression ? dayData.click / dayData.impression : 0 ) * 100;
                    dayData.cpm = (dayData.impression ? dayData.cost / dayData.impression : 0) * 1000;
                    return dayData;
                });
