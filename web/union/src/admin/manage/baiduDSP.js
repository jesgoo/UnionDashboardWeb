 ...
 */
(function () {
    mf.admin.manage.baiduDSP = new er.Action({
        model: mf.admin.manage.model.baiduDSP,
        view: new er.View({
            template: 'mf_admin_manage_baiduDSP',
            UI_PROP: {}
        }),
        STATE_MAP: {
            page: 0,
        ...
        onafterrender: function () {
            ...
            var table = esui.get('baiduDSPlist');
            table.order = 'asc';
            ...
            var saveRow = function (rowIndex) {
                ...
                if (mf.tableSavingValidator(row, table.fields)) {
                    mf.parallelAjax({
                        type: 'POST',
                        url: '/admin/baiduadslot' + (row._isNew ? '' : '/' + operateData.get(row, 'id')),
            ...
            var refreshTable = mf.mockPager(dataList, {
                pager: esui.get('baiduDSPpager'),
                pageSizer: esui.get('baiduDSPpageSize'),
                table: table
            }, {
