...
(function (exports, module) {
    ...
    var highchart_monitor_mini = function (element, cData, opt) {
        ...
        var serials = $.map(cData.data, function (data, name){
            return {
                name: name,
                type: 'spline',
                yAxis: 0,
        ...
        return $(element).highcharts({
            ...
            colors: ["#f6505c", "#1c62b8", "#f6c928", "#19b2b7", "#8772cd", "#eb6f25", "#e549d1", "#98f611", "#47b8ff"],
            credits: {
                enabled: false
            },
            exporting: {
    ...
    exports.highchart_monitor_mini = highchart_monitor_mini;
