...
*/
    ...
    mf.ud.report.media = new er.Action({
        model: mf.ud.report.model.media,
        view: new er.View({
            template: 'mf_ud_report_media',
            UI_PROP: {}
        }),
        STATE_MAP: {},
        ...
        onafterrender: function () {
            ...
            var reporter = mf.ud.reportBind(action, '#mediaReportArea');
            reporter(reports, {
                media: mediaId
            });
            model.set(
                    ...
                    [
                        {
                            ...
                            handle: function (options) {
                                window.open('#/report/position~media=' + mediaId + '&name=' + options.name+ '&adslot=' + options.adslot);
                            }
                        }
                    ],
                    {
