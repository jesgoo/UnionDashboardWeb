(function (){
    ...
    var generator = function (adTypeName, contentData, layoutData, scaleData, debug) {
        ...
        _.regTemplate('custom_tpl_source', templateResult.replace(/<\\\\%/g, '<%').replace(/%\\\\>/g, '%>').replace(/ {4}/g, ''), {});
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='<!doctype html><html style="height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width, user-scalable=yes, initial-scale=1.0, minimal-ui"><link rel="stylesheet" type="text/css" href="http://cdn.jesgoo.com/sdk/banner/javascript/diy.css"></head><body style="height: 100%;"><script src="http://cdn.jesgoo.com/sdk/banner/javascript/ck.js"></script>';
return __p;
});
_('click_monitor').templateCache(function(data){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='';
 if (!data.debug) { 
...
'\n<a id="jg-link" class="jg-banner jg-free" stamp="<\\\\%=data.Stamp%\\\\>" href="<\\\\%=data.ClickUrl%\\\\>" target="_blank">\n    '+
...
_('interface').templateCache(function(data){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='(function (jesgoo) {\r\n    var gel = window.errorLog = window.errorLog || [];\r\n    gel.push(\'ck\');\r\n    var runCount = 0;\r\n    var hasJesgoo = 0;\r\n    var runner = function () {\r\n        if (jesgoo && !hasJesgoo) {\r\n            jesgoo.triggerCK();\r\n            hasJesgoo = 1;\r\n        }\r\n        if (hasJesgoo) {\r\n            var list = [\r\n                jesgoo.monitorID,\r\n                \'jesgoo-link\',\r\n                \'jg-link\'\r\n            ], $a;\r\n            for (var i = 0; i < list.length; i+=1) {\r\n                list[i] && ($a = document.getElementById(list[i]));\r\n                if ($a) break;\r\n            }\r\n        }\r\n        if (!$a) {\r\n            runCount += 1;\r\n            setTimeout(runner, 25);\r\n        } else {\r\n            var origin_href = $a.href;\r\n            if ($a.getAttribute(\'ck\') !== \'1\'){\r\n                var clickCount = 0;\r\n                gel.push(\'ckr\');\r\n                $a.setAttribute(\'ck\', \'1\');\r\n                $a.addEventListener(\'click\', function (e) {\r\n                    var ckString = \'.\' + jesgoo.getCk($a, e);\r\n                    if (jesgoo.ckValue && $a.href) {\r\n                        $a.href = origin_href + ckString;\r\n                        clickCount += 1;\r\n                    }\r\n                    if ($a.href && clickCount < 2) {\r\n                        click_monitor($a.parentNode);\r\n                        clickCount += 1;\r\n                    }\r\n                });\r\n            }\r\n            if ($a.getAttribute(\'post\') !== \'1\' && origin_href) {\r\n                gel.push(\'post\');\r\n                var monitor = [];\r\n                /*\r\n                 [].forEach.call($a.parentNode.childNodes, function (n) {\r\n                 if (n.name == \'click\' && n.value) {\r\n                 n.name = \'get_monitor\';\r\n                 monitor.push(n.value);\r\n                 }\r\n                 });\r\n                 */\r\n                var form = document.createElement(\'form\');\r\n                document.body.appendChild(form);\r\n                form.method = \'post\';\r\n                form.action = origin_href;\r\n                var key = document.createElement(\'input\');\r\n                key.type = \'hidden\';\r\n                key.name = \'query\';\r\n                form.appendChild(key);\r\n                $a.setAttribute(\'post\', \'1\');\r\n                if (monitor.length) {\r\n                    var monitorList = document.createElement(\'input\');\r\n                    monitorList.type = \'hidden\';\r\n                    monitorList.name = \'monitors\';\r\n                    monitorList.value = monitor.join(\' \');\r\n                    form.appendChild(monitorList);\r\n                }\r\n                $a.addEventListener(\'click\', function (e) {\r\n                    var ckString = \'.\' + jesgoo.getCk($a, e);\r\n                    form.action = origin_href + ckString;\r\n                    key.value = form.action.split(\'?\')[1] || \'\';\r\n                    form.target = $a.getAttribute(\'target\');\r\n                    form.submit();\r\n                    $a.href = \'javascript:void(0);//\';\r\n                });\r\n            }\r\n        }\r\n    };\r\n    runner();\r\n    function click_monitor(container) {\r\n       [].forEach.call(container.childNodes, function (n) {\r\n            if (n.name == \'click\' && n.value) {\r\n                var image = new Image();\r\n                image.src = n.value;\r\n                image.style.display = \'none\';\r\n                container.appendChild(image);\r\n            }\r\n        });\r\n    }\r\n})(this.jesgoo);\r\n';
return __p;
});
...
'\n}\n'+
((__t=(data.content.animation))==null?'':__t)+
'\n</style>\n<a id="jg-link" class="jg-banner jg-text-icon layout-area" stamp="<\\\\%=data.Stamp%\\\\>" href="<\\\\%=data.ClickUrl%\\\\>" target="_blank">\n    ';
