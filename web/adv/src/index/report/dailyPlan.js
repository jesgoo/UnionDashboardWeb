 ...
 */
(function () {
    mf.index.report.dailyPlan = new er.Action({
        model: mf.index.report.model.dailyPlan,
        view: new er.View({
            template: 'mf_index_report_dailyPlan',
            UI_PROP: {}
        }),
        STATE_MAP: {
        ...
        onafterrender: function () {
            ...
            var dateRegion = esui.get('dailyPlanDateRegion');
        ...
        onentercomplete: function () {
            ...
            var dateRegion = esui.get('dailyPlanDateRegion');
            mf.m.highchart_overview('#dailyPlanChart', model.get('lists'), dateRegion.getValueAsObject());
        },
        onleave: function () {
            console.log('onleave');
        }
